              ...
              {activeTab === 'nights' && (
                <div className="contract-section-stack">
                  ...
                  <div className="contract-input-grid">
                    ...
                    <label className="facility-field"><span>Days off after night block</span><input type="number" value={formState.night_settings.days_off_after_night_block} onChange={(event) => setFormState((current) => ({ ...current, night_settings: { ...current.night_settings, days_off_after_night_block: event.target.value } }))} /></label>
                    <label className="facility-field"><span>Days off after night block penalty</span><input type="number" value={formState.night_settings.days_off_after_night_block_penalty_weight} onChange={(event) => setFormState((current) => ({ ...current, night_settings: { ...current.night_settings, days_off_after_night_block_penalty_weight: event.target.value } }))} /></label>
                    <label className="facility-field"><span>Days off before another night shift</span><input type="number" value={formState.night_settings.days_off_before_next_night_shift} onChange={(event) => setFormState((current) => ({ ...current, night_settings: { ...current.night_settings, days_off_before_next_night_shift: event.target.value } }))} /></label>
                    <label className="facility-field"><span>Days off before another night shift penalty</span><input type="number" value={formState.night_settings.days_off_before_next_night_shift_penalty_weight} onChange={(event) => setFormState((current) => ({ ...current, night_settings: { ...current.night_settings, days_off_before_next_night_shift_penalty_weight: event.target.value } }))} /></label>
                  </div>
                </div>
              )}
